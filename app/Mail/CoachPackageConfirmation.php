...
class CoachPackageConfirmation extends Mailable
{
    ...
    public function build()
    {
        ...
        $emailData = [
            ...
            'chatNowUrl' => env('APP_CLIENT_DOMAIN_CHAT_PAGE') . '?userId=' . $packageBuyerUser->id,
        ...
        return $this->view('emails.coachPackageConfirmation')
            ->with($emailData);
    }
}
